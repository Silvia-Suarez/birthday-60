...
export default function FunFacts() {
  ...
  return (
    <section className="py-16 bg-white-ivory relative">
      ...
      <div className="relative flex flex-wrap justify-center gap-6 px-4">
        {curiosities.map((c, i) => {
          ...
          return (
            <motion.div
              key={c.id}
              className="w-48 h-64 bg-white rounded-xl shadow-lg overflow-hidden cursor-pointer border-4 border-gold"
